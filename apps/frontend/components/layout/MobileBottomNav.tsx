...
export default function MobileBottomNav() {
  ...
  const mobileNavItems = navItems.filter((item) =>
    ["Home", "Assignments", "My Library", "AI Teacher's Toolkit"].includes(
      item.name,
    ),
  );
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 pointer-events-none">
      ...
      <div className="px-4 pb-4 pointer-events-auto">
        <nav className="bg-[#1c1c1e] rounded-3xl flex items-center justify-between px-6 py-3 shadow-[0_18px_50px_-20px_rgba(0,0,0,0.65)]">
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {item.name === "AI Teacher's Toolkit"
                    ? "AI Toolkit"
                    : item.name}
                </span>
              </Link>
